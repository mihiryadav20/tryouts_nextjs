...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/mihir-s-yadav/Documents/Codes and Docs/Practise Code/Tryouts_nextjs/tryouts/server/models/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/mihir-s-yadav/Documents/Codes and Docs/Practise Code/Tryouts_nextjs/tryouts/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../server/models/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "f7e681efcddb97ef949953369ca6f35f296aa6408b560340f8f19dfd12b6d4f2",
  "copyEngine": true
}
...
path.join(process.cwd(), "server/models/prisma/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "server/models/prisma/schema.prisma")
